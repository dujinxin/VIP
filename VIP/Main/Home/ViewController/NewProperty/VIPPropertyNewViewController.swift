//
//  VIPPropertyNewViewController.swift
//  VIP
//
//  Created by 飞亦 on 6/19/19.
...
class VIPPropertyNewViewController: VIPBaseViewController {
...
//        headView.addSubview(tabBgView)
        ...
        //self.tableView.register(VIPPropertyContentCell.self, forCellReuseIdentifier: reuseIdentifier)
...
extension VIPPropertyNewViewController: UITableViewDataSource,UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return kScreenHeight - kNavStatusHeight - headViewHeight
    }
...
extension VIPPropertyNewViewController {
...
extension VIPPropertyNewViewController : JXXBarViewDelegate {
...
extension VIPPropertyNewViewController : JXHorizontalViewDelegate {
